...
for (i in 0:(niter-1)) {
  filename = paste('results/autYsim/', datafolder, 'fpr/', runfolder, 'subLRs_iter', format(i), '.res', sep='') 
...
for (i in 0:(niter-1)) {
  filename = paste('results/autYsim/', datafolder, 'p-o/', runfolder, 'subLRs_iter', format(i), '.res', sep='') 
...
for (i in 0:(niter-1)) {
  filename = paste('results/autYsim/', datafolder, 'sib/', runfolder, 'subLRs_iter', format(i), '.res', sep='') 
...
for (i in 0:(niter-1)) {
  filename = paste('results/autYsim/', datafolder, 'cousin/', runfolder, 'subLRs_iter', format(i), '.res', sep='') 
...
for (i in 0:(niter-1)) {
  filename = paste('results/autYsim/', datafolder, 'halfcousin/', runfolder, 'subLRs_iter', format(i), '.res', sep='') 
...
for (i in 0:(niter-1)) {
  filename = paste('results/autYsim/', datafolder, '2cousin/', runfolder, 'subLRs_iter', format(i), '.res', sep='') 
...
for (i in 0:(niter-1)) {
  filename = paste('results/autYsim/', datafolder, 'halfsib/', runfolder, 'subLRs_iter', format(i), '.res', sep='') 
...
#for (i in 0:(niter-1)) {
#  filename = paste('results/autYsim/', datafolder, 'halfsib/', runfolder, 'subLRs_iter', format(i), '.subsampres', sep='') 
...
#for (i in 0:(niter-1)) {
#  filename = paste('results/autYsim/', datafolder, 'halfsib/', runfolder, 'subLRs_iter', format(i), 'subsamp.res', sep='') 
...
filename = paste('results/autYsim/', datafolder, 'sibComparativeDistributionsSubSamp.eps', sep='') 
...
popgroups = c('Vietnamese', 'African American', 'European American', 'Latino', 'Navajo')
for(i in 1:5) {
  for(j in 1:5) {  
...
filename = paste('results/autYsim/', datafolder, 'relativeFPRsSubSamp.eps', sep='') 
...
popgroups = c('Vietnamese', 'African American', 'European American', 'Latino', 'Native American')
